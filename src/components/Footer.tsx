...
const Footer = () => {
  return (
    <footer className="py-6 w-full text-center flex flex-col gap-6 md:grid md:grid-cols-3">
      <div className="">
        <h1 className="text-2xl mb-4 text-amber-600">Design</h1>
      ...
      <div className="">
        <h1 className="text-2xl mb-4 text-amber-600">Site</h1>
        <ul className="flex flex-col gap-2">
          <li>
            <Link href="/">Home</Link>
          </li>
      ...
      <div className="">
        <h1 className="text-2xl mb-4 text-amber-600">Links</h1>
